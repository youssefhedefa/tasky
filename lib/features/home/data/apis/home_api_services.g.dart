...
class _HomeApiServices implements HomeApiServices {
  ...
  Future<AddTaskResponseModel> createTask({
    ...
    final _options = _setStreamType<AddTaskResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddTaskResponseModel _value;
    try {
      _value = AddTaskResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<TasksResponseModel>> getTasks({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<TasksResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<TasksResponseModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              TasksResponseModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
